...
/**
 * La clase dados encargado de generar los dados de la partida de forma
 * aleatoria de 1 al 6. Contiene el resultado de los 3 dados. Además, permite
 * cambiar los dados, en caso de que el jugador así lo quiera.
 * 
 */
public class Dados {
  ...
  /**
   * Set dado 1 Da valor al dado 1 mediante un generador aleatorio de 1 a 6
   */
  public void setD1() {
  ...
  /**
   * Set dado 2 Da valor al dado 2 mediante un generador aleatorio de 1 a 6
   */
  public void setD2() {
  ...
  /**
   * Cambiar dados. Al tirar los dados puedes solicitar cambiar 1, 2 o los 3
   * dados.
   * 
   * @param nDadosCambiar
   * @return dados
